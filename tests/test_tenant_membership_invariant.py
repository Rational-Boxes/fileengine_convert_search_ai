...
from convert_search_ai import http_auth, ldap_auth, tenant_access
...
def test_identity_from_claims_refuses_a_foreign_tenant():
    ...
    from convert_search_ai import jwt_verify
    claims = _claims({"alpha": ["users"]})
...
def test_bridge_verifier_refuses_a_foreign_tenant(monkeypatch):
    ...
    from convert_search_ai import bridge_auth, token_revocation
